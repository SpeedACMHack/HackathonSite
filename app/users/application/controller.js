            ...
            .exec((err, application) => {
              ...
              if (req.body.status == Application.Status.APPROVED) {
                ...
                new Email({
                  ...
                  body: '## You\'re invited!\n\n\nCongratulations, you have been accepted to DerbyHacks. Please RSVP here: [derbyhacks.io/rsvp](http://derbyhacks.io/rsvp).\n\n\nUntil then, a few things to note:\n\n\n**What you should bring:**\n- Deodorant\n- Laptop and charger\n- Valid school ID\n- Phone/charger\n- Change of clothes\n- Deodorant\n- Basic toiletries\n- Pillow and blanket\n- Deodorant\n\n\n**Hackers looking for travel reimbursements:** Please submit a request on the contact form of [our website](http://derbyhacks.io) and we\'ll get back to you. Hackers may receive travel reimbursement on a first come first serve basis.\n\n\n**Hackers under the age of 18:** Please have a parent/guardian sign our minor waiver [http://derbyhacks.io/MinorWaiver.pdf](http://derbyhacks.io/MinorWaiver.pdf) and return that to us at [team@derbyhacks.io](mailto:team@derbyhacks.io) before the event.\n\n\n**Make sure your resume is attached to your application if you\'re looking for full time jobs or internships.** You can edit your application by logging in at [derbyhacks.io](http://derbyhacks.io)\n\n\nWe\'re looking forward to seeing you on April 9th!\n\n\n\nRegards,\n\nDerbyHacks Team',
                  recipients: {
                    emails: [user.email]
                  }
                }).send();
                ...
                new Email({
                  ...
                  body: 'Hello,\n\nYou have been added to the DerbyHacks waitlist. Please standby for further emails, as we will try to accomodate as many hackers from the waitlist as we can. \n\n\n\nRegards,\n\nDerbyHacks Team',
                  recipients: {
                    emails: [user.email]
                  }
                }).send();
                ...
                // Send denial email
                new Email({
                  subject: 'DerbyHacks Status: Denied',
                  body: 'Hello,\n\nWe\'re sorry to say that you have been denied from DerbyHacks. We are trying to accomodate as many hackers as we can, but we just can\'t fit everyone in our venue. Thank you so much for your interest, and please come again next year! \n\n\n\nRegards,\n\nDerbyHacks Team',
                  recipients: {
                    emails: [user.email]
                  }
                }).send();
